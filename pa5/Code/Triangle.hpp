...
public:
    ...
    // 判断是否和棋盘有交点，返回光线距离最近的交点对应的：
    // 光线距离tnear、求交点的系数uv、所在三角形序号index、是否有交点intersect
    ...
    // 返回三角形表面法线N，MollerTrumbore算法得到的三角形与光线交点
